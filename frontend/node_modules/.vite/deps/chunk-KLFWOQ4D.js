...
function focusChild(el, location, options) {
  ...
  if (location == null) {
    if (el === document.activeElement || !el.contains(document.activeElement)) {
      (_a = focusable[0]) == null ? void 0 : _a.focus(options);
    }
  } else if (location === "first") {
    (_b = focusable[0]) == null ? void 0 : _b.focus(options);
  } else if (location === "last") {
    (_c = focusable.at(-1)) == null ? void 0 : _c.focus(options);
  } else if (typeof location === "number") {
    (_d = focusable[location]) == null ? void 0 : _d.focus(options);
  } else {
...
//# sourceMappingURL=chunk-KLFWOQ4D.js.map
